...
namespace TestApp
{
    ...
    public class TestAppWebCoreModule : AbpModule
    {
        ...
        public TestAppWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(TestAppWebCoreModule).GetAssembly());
        }

        public override void PostInitialize()
        {
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(TestAppWebCoreModule).Assembly);
        }
    }
}
